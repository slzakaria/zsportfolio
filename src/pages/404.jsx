				...
				<div className='flex items-center justify-center mt-24 gap-x-6'>
					<Link href='/'>
						<div className='mt-5 relative px-6 py-3 text-black rounded-lg group'>
							<span className='absolute inset-0 w-full h-full transition duration-300 transform -translate-x-1 -translate-y-1 bg-white ease opacity-80 group-hover:translate-x-0 group-hover:translate-y-0'></span>
