...
export function Projects() {
	...
	return (
		<section className='mt-12'>
			<h1 className='text-2xl font-jetBrain'>What i built on the side</h1>
			<ul className='mt-5 flex flex-col gap-2'>
				{projects.map((project) => (
					<li key={project.id} className='group font-heebo'>
						<Link href={project.link} className='flex gap-5 items-center'>
							...
							<div className='w-full mr-2 border-t border-gray-700 rounded-2 transition duration-110 opacity-80 group-hover:border-white'></div>
